#!/bin/bash
#
# Preventive Screening Study - OMOP Data Analysis
# 
# Scenario: Regular colonoscopy screening vs no screening
# Outcome: Colorectal cancer diagnosis (binary)
# Data: OMOP CDM-based synthetic patient data
# Confounders: Age, health consciousness, family history, lifestyle
#
...
echo "=========================================================="
echo "Preventive Screening Study"
...
if [ ! -d "$OMOP_DATA_DIR" ]; then
  ...
  echo "   1. Generate data: python3 research/causal-inference/data-generation/synthea/generate-omop-data.py --scenario screening --n-patients 6000"
  echo "   2. Split data: python3 research/causal-inference/data-generation/split-omop-data.py --input output/screening/screening/causal-data.json --output-dir $OMOP_DATA_DIR --num-sites 5"
  exit 1
fi
...
========================================================================
Preventive Screening Study - OMOP Data - Assumption Comparison
========================================================================
