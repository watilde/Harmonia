...
runOmopExperiment({
  ...
  dataGenerationSteps: [
    ...
    '2. Split data: python3 research/causal-inference/data-generation/split-omop-data.py --input output/icu/icu/causal-data.json --output-dir research/experiments/icu-intervention/data/omop --num-sites 4',
  ],
