#!/bin/bash
#
# ICU Early Intervention Study - OMOP Data Analysis
# 
# Scenario: Early intervention protocol vs standard care in ICU
# Outcome: 30-day survival (binary)
# Data: OMOP CDM-based synthetic patient data
# Confounders: Age, APACHE score, comorbidities, admission type
#
...
echo "=========================================================="
echo "ICU Early Intervention Study"
...
if [ ! -d "$OMOP_DATA_DIR" ]; then
  ...
  echo "   1. Generate data: python3 research/causal-inference/data-generation/synthea/generate-omop-data.py --scenario icu --n-patients 3200"
  echo "   2. Split data: python3 research/causal-inference/data-generation/split-omop-data.py --input output/icu/icu/causal-data.json --output-dir $OMOP_DATA_DIR --num-sites 4"
  exit 1
fi
...
========================================================================
ICU Intervention Study - OMOP Data - Assumption Comparison
========================================================================
