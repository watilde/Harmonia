...
async function main(): Promise<void> {
  ...
  console.log('');
  console.log('📁 Data location: research/data-generation/omop-data/');
  console.log('');
  console.log('🚀 Next steps:');
  console.log('   1. Run validation:');
  console.log('      npx ts-node research/scripts/validation/large-scale.ts');
  console.log('');
  console.log('   2. Or use complete pipeline:');
  console.log('      ./research/data-generation/complete-scale-validation.sh');
  console.log('');
}
...
Usage:
  npx ts-node research/scripts/data/download/synthea.ts [options] [scales...]
