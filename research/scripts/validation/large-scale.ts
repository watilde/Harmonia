 ...
 * - 1M patients (xxlarge)
 *
 * Results saved to research/data-generation/results/large-scale-validation/
 *
 * USAGE:
 *   # Run all scales
 *   npx ts-node research/data-generation/run-large-scale-validation.ts
 *
 *   # Run specific scales only
 *   npx ts-node research/data-generation/run-large-scale-validation.ts small medium large
 */
...
const ALL_SCALE_TESTS: ScaleTest[] = [
  {
    size: 'small',
    nPatients: 1000,
    dataPath: '../../data-generation/splits/1k/site1.json',
  },
  {
    size: 'medium',
    nPatients: 10000,
    dataPath: '../../data-generation/splits/10k/site1.json',
  },
  {
    size: 'large',
    nPatients: 100000,
    dataPath: '../../data-generation/splits/100k/site1.json',
  },
  {
    size: 'xlarge',
    nPatients: 500000,
    dataPath: '../../data-generation/splits/500k/site1.json',
  },
  {
    size: 'xxlarge',
    nPatients: 2800000,
    dataPath: '../../data-generation/splits/2.8m/site1.json',
  },
];
...
async function main() {
  ...
  // Save results
  const outputDir = path.join(__dirname, 'results/large-scale-validation');
