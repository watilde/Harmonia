...
runOmopExperiment({
  ...
  dataGenerationSteps: [
    ...
    '2. Split data: python3 research/causal-inference/data-generation/split-omop-data.py --input output/screening/screening/causal-data.json --output-dir research/modules/manski-bounds/experiments/preventive-screening/data/omop --num-sites 5',
  ],
