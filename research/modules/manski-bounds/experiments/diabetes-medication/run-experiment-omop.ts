...
runOmopExperiment({
  ...
  dataGenerationSteps: [
    ...
    '2. Split data: python3 research/causal-inference/data-generation/split-omop-data.py --input output/diabetes/causal-data.json --output-dir research/modules/manski-bounds/experiments/diabetes-medication/data/omop --num-sites 3',
  ],
