...
exports.OMOP_CONCEPTS = void 0;
exports.generateOMOPSyntheticData = generateOMOPSyntheticData;
exports.exportOMOPDataset = exportOMOPDataset;
/**
 ...
 */
function generateDiabetesOMOP(config) {
    ...
    for (let i = 0; i < config.numPatients; i++) {
        ...
        persons.push({
            person_id: personId,
            gender_concept_id: rng.next() > 0.5 ? exports.OMOP_CONCEPTS.MALE : exports.OMOP_CONCEPTS.FEMALE,
            year_of_birth: 2024 - age,
            race_concept_id: exports.OMOP_CONCEPTS.WHITE,
            ethnicity_concept_id: exports.OMOP_CONCEPTS.NOT_HISPANIC,
        });
        ...
        conditions.push({
            ...
            person_id: personId,
            condition_concept_id: exports.OMOP_CONCEPTS.TYPE2_DIABETES,
            condition_start_date: '2023-01-01',
            condition_type_concept_id: exports.OMOP_CONCEPTS.EHR,
        });
        ...
        measurements.push({
            ...
            person_id: personId,
            measurement_concept_id: exports.OMOP_CONCEPTS.HBA1C,
        ...
        if (treatment === 1) {
            ...
            drugs.push({
                ...
                person_id: personId,
                drug_concept_id: exports.OMOP_CONCEPTS.NEW_DIABETES_DRUG,
                drug_exposure_start_date: indexDate,
                drug_type_concept_id: exports.OMOP_CONCEPTS.EHR,
            });
        }
        else {
            ...
            drugs.push({
                drug_exposure_id: drugId++,
                person_id: personId,
                drug_concept_id: exports.OMOP_CONCEPTS.METFORMIN,
                drug_exposure_start_date: indexDate,
                drug_type_concept_id: exports.OMOP_CONCEPTS.EHR,
            });
        }
 ...
 */
function generateICUOMOP(config) {
    const rng = new SeededRandom(config.seed ?? 42);
    const indexDate = config.indexDate ?? '2024-01-01';
    ...
    for (let i = 0; i < config.numPatients; i++) {
        ...
        visits.push({
            ...
            person_id: personId,
            visit_concept_id: exports.OMOP_CONCEPTS.INPATIENT,
            visit_start_date: indexDate,
            visit_end_date: '2024-01-10',
            visit_type_concept_id: exports.OMOP_CONCEPTS.EHR,
        });
        // Primary condition (Sepsis)
        conditions.push({
            condition_occurrence_id: conditionId++,
            person_id: personId,
            condition_concept_id: exports.OMOP_CONCEPTS.SEPSIS,
        ...
        measurements.push({
            measurement_id: measurementId++,
            person_id: personId,
            measurement_concept_id: exports.OMOP_CONCEPTS.APACHE_SCORE,
        ...
        if (treatment === 1) {
            procedures.push({
                ...
                person_id: personId,
                procedure_concept_id: exports.OMOP_CONCEPTS.CENTRAL_LINE,
                procedure_date: indexDate,
                procedure_type_concept_id: exports.OMOP_CONCEPTS.EHR,
            });
        }
 ...
 */
function generateScreeningOMOP(config) {
    const rng = new SeededRandom(config.seed ?? 42);
    const indexDate = config.indexDate ?? '2024-01-01';
    ...
    for (let i = 0; i < config.numPatients; i++) {
        ...
        visits.push({
            visit_occurrence_id: visitId++,
            person_id: personId,
            visit_concept_id: exports.OMOP_CONCEPTS.OUTPATIENT,
            visit_start_date: indexDate,
        ...
        if (screened === 1) {
            procedures.push({
                procedure_occurrence_id: procedureId++,
                person_id: personId,
                procedure_concept_id: exports.OMOP_CONCEPTS.COLONOSCOPY,
                procedure_date: indexDate,
                procedure_type_concept_id: exports.OMOP_CONCEPTS.EHR,
            });
        }
        ...
        if (cancer === 1) {
            ...
            conditions.push({
                condition_occurrence_id: conditionId++,
                person_id: personId,
                condition_concept_id: exports.OMOP_CONCEPTS.COLON_CANCER,
 ...
 */
function generateOMOPSyntheticData(config) {
 ...
 */
function exportOMOPDataset(dataset, outputDir) {
    const files = {};
...
//# sourceMappingURL=omop-synthetic.js.map