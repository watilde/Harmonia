...
exports.computeFRI = computeFRI;
exports.compareFRIStrategies = compareFRIStrategies;
exports.formatFRI = formatFRI;
exports.printFRIReport = printFRIReport;
exports.printFRIComparison = printFRIComparison;
exports.assessHeterogeneity = assessHeterogeneity;
/**
 ...
 */
function computeFRI(siteEvalues, strategy = 'sample-size') {
 ...
 */
function classifyRobustness(min_evalue) {
    if (min_evalue === 1) {
        return 'none';
    }
 ...
 * Interpret FRI
 */
function interpretFRI(min_evalue, std_evalue) {
 ...
 */
function compareFRIStrategies(siteEvalues) {
    const strategies = ['sample-size', 'sqrt', 'log', 'equal'];
    const results = {};
 ...
 */
function printFRIComparison(comparison) {
    console.log('');
    console.log('═'.repeat(70));
...
function assessHeterogeneity(siteEvalues) {
    const evalues = siteEvalues.map(s => s.evalue);
...
//# sourceMappingURL=robustness-index.js.map