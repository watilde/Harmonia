 ...
 */
export declare function extractCausalDataFromOMOP(dataset: OMOPDataset, config: OMOPExtractionConfig): CohortExtractionResult;
/**
 * Save cohort extraction result to JSON
 */
export declare function saveCohortExtraction(_result: CohortExtractionResult, _outputPath: string): void;
